...
#define BACKEND_NAME        canon_lide
#define CANONUSB_CONFIG_FILE "canon_lide.conf"
#include "../include/sane/sanei_backend.h"

#include "canon_lide-common.c"
...
/* This option lets the user select the scan resolution in dpi */
static const SANE_Word optionResolutionList[] = {
  1,				/* Number of elements */
  /*75, 150,*/ 300/*, 600, 1200*/	/* Resolution list */
};
...
optionTopLeftXCallback (SANE_Option * option, SANE_Handle handle,
			SANE_Action action, void *value, SANE_Int * info)
{
  /* Eliminate warning about unused parameters */
  option = option;
  handle = handle;
...
callback routine, it ought to be called by sane_control_option
...
sane_init (SANE_Int * version_code, SANE_Auth_Callback authorize)
{
  ...
  DBG (1, "sane_init: SANE Canon LiDE backend version %d.%d.%d from %s\n",
